...
public class LibraryEventConsumerConfig {
    ...
    ConcurrentKafkaListenerContainerFactory<?, ?> kafkaListenerContainerFactory(
        ...
        factory.setConcurrency(3); // Incase of non-cloud/non-k8s then we can bring multiple threads from same instance for concurrency
    ...
    private RetryTemplate retryTemplate() {
        ...
        fixedBackOffPolicy.setBackOffPeriod(1000); //ms - backoff
